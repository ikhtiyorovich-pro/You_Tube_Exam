...
function Channel() {
  ...
  return (
    <div className="channel-all-wrapper">
      <div className="channel-top-big-img">
      ...
      <div>
        ...
        <div className="main-video-wrapper">
          <div>
            <Link to="/player">
              <img className="main-video-wrapper__img" src={VideoImg} alt="" />
            </Link>
          </div>
          <div>
        ...
        <div className="bottom-video-wrapper">
          <h2 className="bottom-video-wrapper__heading">Margaret Phelps videos</h2>
